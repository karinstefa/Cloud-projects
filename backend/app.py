...
app.config[
    'SQLALCHEMY_DATABASE_URI'] = "postgresql://postgres:cloud1234@database-2.cnjddgnl0ynw.us-east-1.rds.amazonaws.com:5432/db_concursos"
# base de datos
db = SQLAlchemy(app)
ma = Marshmallow(app)
...
class Concursos_Schema(ma.Schema):
    class Meta:
        fields = ("id", "id_admin", "nombre", "path_banner", "fecha_inicio", "fecha_fin", "valor_premio", "guion",
                  "recomendaciones", "url")
...
class Voces_Schema(ma.Schema):
    class Meta:
        fields = (
        "id", "id_concurso", "nombres", "apellidos", "correo", "path_original", "path_convertido", "observaciones",
